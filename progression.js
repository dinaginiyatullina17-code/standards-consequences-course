...
const FINAL_QUESTIONS = [
  ...
  { right: 1, hint: 'Сначала не дай нарушению продолжиться и создать риск для Гостя.', explanation: 'Нужно остановить риск и отреагировать сразу, а затем дать сотруднику обратную связь.' },
...
const WRONG_REASONS = {
  ...
  'final-1': { 0: 'До конца часа пик нарушение может повториться и затронуть других Гостей.', 2: 'Наблюдение коллег не останавливает уже замеченный риск.' },
...
const CORRECT_REASONS = {
  ...
  'final-1': 'первое действие должно прекратить риск, а обратную связь нужно дать сразу',
